...
const Tour = () => {
  ...
  if (isLoading) return <SkeletonTour />;
              ...
              {reviewSummary?.review_count > 0 && (
                ...
                >
                  <StarRating
                    ...
                    size="sm"
                  />
                  <span className="tour__rating-avg">
                    {reviewSummary.avg_rating}
                  </span>
                  <span className="tour__rating-count">
              ...
              <div className="tour-tags">
                <div className="tour-tags--l">
                  ...
                  <div className="tour-duration">
                    ...
                    <div className="tour-duration-price">
                      <p className="tour-duration__hour">{activity_level}</p>
                    </div>
                  </div>
                </div>
                  ...
                  >
                    <div className="heart-container">
                      ...
                      <img
                        src={saveIconFilled}
                        alt="saved"
                        className={`heart-icon ${isLiked ? "visible" : "hidden"}`}
                      />
                    </div>
          ...
          <div className="tour-details-wrp">
            <div className="tour-details" id="overview">
              ...
              <div className="tour-summary" id="details">
                ...
                <div className="tour-el">
                  <h4 className="tour-el__title">Min. attendees</h4>
                  <p className="tour-el__content">
                    A minimum of {minimum_of_attendees} people is required.
                  </p>
                </div>
                <div className="tour-el">
